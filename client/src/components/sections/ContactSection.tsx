...
const ContactSection: React.FC = () => {
  ...
  // Effect to handle reCAPTCHA when theme changes
  useEffect(() => {
    // Reset the token and force a re-render of the reCAPTCHA component
    setCaptchaToken(null);
    setCaptchaKey(Date.now()); // Change key to force complete re-rendering
  }, [theme]);

  // Handle reCAPTCHA token via onChange
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:ruchiratharanka2@gmail.com" className="text-foreground/70 hover:text-primary transition-colors">
                      ruchiratharanka2@gmail.com
                    </a>
                  </div>
                </div>
                <div className="flex items-start">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:[grid-template-columns:repeat(2,1fr)] md:grid-cols-1 lg:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all text-[14px]"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all resize-none text-[14px]"
